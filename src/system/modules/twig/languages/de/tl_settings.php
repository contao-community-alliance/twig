 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_settings']['twigDebugMode']      = array('Debugmodus aktivieren',
...
$GLOBALS['TL_LANG']['tl_settings']['twigDebugExtension'] = array('Debug-Erweiterung aktivieren',
